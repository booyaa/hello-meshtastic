# pretty much pdxlocation's https://github.com/pdxlocations/Meshtastic-Python-Examples/blob/main/MQTT/receive-mqtt-packets.py
...
TOPICS = os.getenv("MESHTASTIC_TOPICS", "msh/US/2/e/LongFast/#").split(",")
...
def on_message(client, userdata, msg):
    ...
    print(decoded_mp)
    # import pprint
    # pprint.pprint(decoded_mp)
    decoded_payload = decoded_mp.decoded.payload.decode('utf-8', errors='ignore')
